        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('penghuni*') ? 'active' : '' }}" href="/penghuni">Penghuni</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('kost*') ? 'active' : '' }}" href="/kost">Rumah Kost</a>
                    </li>
                </ul>
                <li class="nav-item dropdown" style="list-style: none !important">
                    @if (auth()->check())
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="/"><i class="fas fa-home"></i> Halaman user</a>
                            </li>
                            <li>
